var baseline_checker_bookmarklet = (function() {
  ...
  // version = Math.random();
  var version = '1.0';
  var domain = document.getElementById('baseline-checker-loader').src.replace(/\/([^\/]+)$/,'/');

  include_css(domain + 'style.css?ver=' + version);

  if (typeof(jQuery) === 'undefined') {
    include_js('//ajax.googleapis.com/ajax/libs/jquery/1.3.2/jquery.min.js');
  }
